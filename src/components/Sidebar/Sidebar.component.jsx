...
const Sidebar = () => {
  return (
    <div className="sidebar">
      <img className="college-logo" src={collegeLogo}></img>
      <ul className="sidebar-nav">
        <li>
          <h3 className="sidebar-nav-item">RECRUITMENT</h3>
          <ul>
            <li><a href="/campaigns" className="sidebar-button">Campaigns</a></li>
            <li><a href="#" className="sidebar-button">Discover</a></li>
            <li><a href="#" className="sidebar-button">Social Tools</a></li>
        ...
        <li>
          ...
          <ul>
            ...
            <li><a href="#" className="sidebar-button">Analytics</a></li>
          </ul>
        </li>
